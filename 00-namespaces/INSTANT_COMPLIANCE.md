...
This document defines the INSTANT standards compliance requirements for the `00-namespaces` root project, ensuring sub-100ms response times, 64-256 parallel agent support, and zero human intervention.
  ...
  instant-compliance:
    ...
    - name: Upload Report
      ...
      with:
        ...
        path: 00-namespaces/instant_report.md
```
