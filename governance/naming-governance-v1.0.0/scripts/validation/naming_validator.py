...
class NamingValidator:
    ...
    def validate_resource_name(self, 
                              name: str, 
                              resource_type: str, 
                              namespace: str = "default") -> List[Violation]:
        """驗證單一資源名稱"""
        violations = []
    ...
    def validate_directory(self, directory: str, pattern: str = "*.yaml") -> Tuple[bool, List[Violation]]:
        """驗證目錄中的所有 YAML 文件"""
        all_violations = []
