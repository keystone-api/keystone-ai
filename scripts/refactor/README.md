...
- **`master-refactor.sh`** - Main orchestration script that runs all three phases
  ```bash
  bash scripts/refactor/master-refactor.sh [--skip-phase PHASE] [--dry-run]
  ```
...
# Skip specific phase
bash scripts/refactor/master-refactor.sh --skip-phase 1
```
