...
class TestNamingGenerator:
    ...
    @pytest.mark.parametrize("env,app,resource,version,expected", [
    ...
    def test_generate_parametrized(self, mock_naming_generator, env, app, resource, version, expected):
...
class TestNamingGeneratorEdgeCases:
    ...
    def test_generate_very_long_name(self, mock_naming_generator):
        ...
        result = mock_naming_generator.generate(long_component, long_component, long_component, "v1.0.0")
...
class TestNamingGeneratorPerformance:
    ...
    @pytest.mark.performance
    def test_validate_performance_1000_names(self, mock_naming_generator, sample_resource_names, benchmark):
