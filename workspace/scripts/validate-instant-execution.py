...
class InstantExecutionValidator:
    ...
    def validate_latency_thresholds(self) -> bool:
        ...
        thresholds = self.manifest.get("spec", {}).get("execution_standards", {}).get("latency_thresholds", {})
    ...
    def validate_parallelism(self) -> bool:
        ...
        parallelism = self.manifest.get("spec", {}).get("execution_standards", {}).get("parallelism", {})
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Instant Execution Manifest Validator"
    )
    parser.add_argument(
        "--manifest",
