...
class GovernanceAgent:
    ...
    def validate_request(self, request_data: Dict[str, Any], request_type: str = "validation") -> Dict[str, Any]:
        """
    ...
    def validate_name(self, name: str, resource_type: str, environment: str, **context) -> Dict[str, Any]:
        """
        ...
        if policy_path.exists():
            try:
                ...
                # If policy file has syntax errors, skip policy-specific validation
                pass
        ...
        return {
            ...
            "suggestions": self._generate_suggestions(name, resource_type, environment) if violations else []
        }
    ...
    def generate_name(self, resource_type: str, environment: str, team: str = None, 
                     service: str = None, version: str = None, **options) -> Dict[str, Any]:
        """
        ...
        if team:
            ...
            components.append(service.split('-')[0])  # Use first part of service name as team
...
def main():
    ...
    if command == "validate":
        ...
        if len(sys.argv) < 4:
            print("Usage: python governance_agent.py generate <type> <env> [team] [service] [version]")
            sys.exit(1)
